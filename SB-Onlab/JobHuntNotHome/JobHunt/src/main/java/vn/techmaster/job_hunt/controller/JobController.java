...
public class JobController {
  ...
  public String listAllJob(Model model) {
    ...
    model.addAttribute("employers",empRepo.getAllHaskMap());
    model.addAttribute("totalApplicant", applicantRepo.countApplicant());
    return "jobhome";
  }
  ...
  public String Search(@ModelAttribute("city") String city, @ModelAttribute("keyword") String keyword, Model model){
    model.addAttribute("jobs",  jobRepo.SearchByKeyword(keyword, city));
    model.addAttribute("employers",empRepo.getAllHaskMap());
    model.addAttribute("totalApplicant", applicantRepo.countApplicant());
  return"jobhome";
  }
